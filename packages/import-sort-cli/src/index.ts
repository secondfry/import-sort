...
import sortImports, { ISortResult } from 'forked-import-sort';
import { IResolvedConfig, getConfig } from 'forked-import-sort-config';
...
let filePatterns = argv._.filter((arg) => typeof arg === 'string') as string[];

...
describe('default config', () => {
  ...
  it('should resolve to default config', () => {
    ...
    assert.equal(config!.parser, resolve(__dirname, 'forked-import-sort-parser-babylon'));
    assert.equal(config!.style, resolve(__dirname, 'forked-import-sort-style-eslint'));
  });
